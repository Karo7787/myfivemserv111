...
Config.Apartments = {
    ...
    ['Tinsel Towers'] = {
        label = 'Tinsel Towers',
        door = { x = -619.15, y = 37.86, z = 43.59, h = 181.03, length = 2, width = 2 },
        imgs = {
            {
...
Config.FurnitureTypes = {
    ["storage"] = function(entity, property_id, shell, id)
        local stash = ("property_%s"):format(id)
        Framework[Config.Target].AddTargetEntity(entity, "Schowek", "fas fa-box-open", function()
            local stashConfig = Config.Shells[shell].stash
            Framework[Config.Inventory].OpenInventory(stash, stashConfig, property_id)
        end)
    ...
    ["clothing"] = function(entity, property_id)
        Framework[Config.Target].AddTargetEntity(entity, "Ubrania", "fas fa-shirt", function()
            exports["mrg_skin"]:OpenOutfitMenu()
        end)
