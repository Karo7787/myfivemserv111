...
const bt = (e) =>
    ee(e)
      ...
      : e == null
      ? ""
      : O(e) || (k(e) && (e.toString === Zs || !L(e.toString)))
...
class Bn {
  ...
  stop() {
    this.active &&
      (as(this), ds(this), this.onStop && this.onStop(), (this.active = !1));
  }
}
function wo(e) {
  return e.value;
    ...
    s._dirtyLevel < t &&
      ...
      s._shouldSchedule &&
        ...
        (!s._runnings || s.allowRecurse) &&
          s._dirtyLevel !== 2 &&
          ((s._shouldSchedule = !1), s.scheduler && En.push(s.scheduler)));
  }
  Wn();
}
const fr = (e, t) => {
...
function Me(e, t, n, s, r, o) {
  ...
  if (t === "clear") l = [...i.values()];
    ...
    switch ((n !== void 0 && l.push(i.get(n)), t)) {
      case "add":
        O(e)
          ? Un(n) && l.push(i.get("length"))
          : (l.push(i.get(et)), ft(e) && l.push(i.get(Sn)));
        break;
      case "delete":
...
class ar {
  ...
  get(t, n, s) {
    ...
    if (n === "__v_raw")
      return s === (r ? (o ? jo : gr) : o ? pr : hr).get(t) ||
    ...
    return (st(n) ? ur.has(n) : Eo(n)) || (r || de(t, "get", n), o)
      ? l
      : me(l)
      ? i && Un(n)
        ? l
...
class dr extends ar {
  ...
  set(t, n, s, r) {
    ...
    if (!this._isShallow) {
      const f = Wt(o);
      if (
        (!Tn(s) && !Wt(s) && ((o = H(o)), (s = H(s))), !O(t) && me(o) && !me(s))
      )
    ...
    return (
      t === H(r) && (i ? tt(s, o) && Me(t, "set", n, s) : Me(t, "add", n, s)), l
    );
  }
  deleteProperty(t, n) {
    const s = N(t, n);
...
function Rt(e, t = !1) {
  const n = this.__v_raw,
    ...
    r = H(e);
  return (
    t || (tt(e, r) && de(s, "has", e), de(s, "has", r)),
    e === r ? n.has(e) : n.has(e) || n.has(r)
  );
}
function Mt(e, t = !1) {
  return (
    (e = e.__v_raw), !t && de(H(e), "iterate", et), Reflect.get(e, "size", e)
  );
}
function ps(e) {
  e = H(e);
...
function gs(e, t) {
  ...
  const i = r.call(n, e);
  return (
    n.set(e, t), o ? tt(t, i) && Me(n, "set", e, t) : Me(n, "add", e, t), this
  );
}
function ms(e) {
  const t = H(this),
...
function Ft(e, t) {
  return function (s, r) {
    const o = this,
      ...
      f = t ? kn : e ? Xn : Jn;
    return (
      !e && de(l, "iterate", et), i.forEach((a, d) => s.call(r, f(a), f(d), o))
    );
  };
}
function Nt(e, t, n) {
  return function (...s) {
    const r = this.__v_raw,
      ...
      d = n ? kn : t ? Xn : Jn;
    return (
      !t && de(o, "iterate", f ? Sn : et),
      {
        next() {
          const { value: _, done: C } = a.next();
          return C
            ? { value: _, done: C }
            : { value: l ? [d(_[0]), d(_[1])] : d(_), done: C };
        },
        [Symbol.iterator]() {
          return this;
        },
...
function ko(e) {
  ...
  Ue &&
    ...
    lr(
      ...
      (t = e.dep) != null
        ? t
        : (e.dep = fr(() => (e.dep = void 0), e instanceof yr ? e : void 0))
    ));
}
function dn(e, t = 4, n) {
  e = H(e);
...
function Qn(e) {
  (!ie.length || !ie.includes(e, At && e.allowRecurse ? Pe + 1 : Pe)) &&
    (e.id == null ? ie.push(e) : ie.splice(Xo(e.id), 0, e), Cr());
}
function Cr() {
...
function Qo(e) {
  O(e)
    ? ut.push(...e)
    : (!He || !He.includes(e, e.allowRecurse ? Ye + 1 : Ye)) && ut.push(e),
    Cr();
}
...
function ei(e, t, ...n) {
  ...
  if (i && i in s) {
    const d = `${i === "modelValue" ? "model" : i}Modifiers`,
      { number: _, trim: C } = s[d] || K;
    C && (r = n.map((T) => (ee(T) ? T.trim() : T))), _ && (r = n.map(xn));
  }
  let l,
    f = s[(l = un(t))] || s[(l = un(Ie(t)))];
...
function Er(e, t, n = !1) {
  ...
  return !o && !l
    ...
    : (O(o) ? o.forEach((f) => (i[f] = null)) : Z(i, o),
      k(e) && s.set(e, i),
      i);
}
function nn(e, t) {
...
function hn(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      ...
      const V = t;
      (z = Oe(
        V.length > 1 ? V(_, { attrs: l, slots: i, emit: f }) : V(_, null)
      )),
        (Y = t.props ? l : si(l));
    }
  } catch (V) {
...
function Tr(
  e,
  t,
  { immediate: n, deep: s, flush: r, once: o, onTrack: i, onTrigger: l } = K
) {
  if (t && o) {
    const R = t;
    t = (...le) => {
  ...
  const z = () => {
    if (!(!$.active || !$.dirty))
      if (t) {
        const R = $.run();
        (s || _ || (C ? R.some((le, I) => tt(le, se[I])) : tt(R, se))) &&
          (T && T(),
          be(t, f, 3, [R, se === $t ? void 0 : C && se[0] === $t ? [] : se, D]),
          (se = R));
      } else $.run();
  };
  z.allowRecurse = !!t;
...
function Qe(e, t = 1 / 0, n) {
  ...
  else if (O(e)) for (let s = 0; s < e.length; s++) Qe(e[s], t, n);
  else if (Ys(e) || ft(e))
    e.forEach((s) => {
      Qe(s, t, n);
    });
  else if (er(e)) for (const s in e) Qe(e[s], t, n);
  return e;
}
function pi(e, t) {
  if (ue === null) return e;
...
function Pn(e, t, n, s) {
  const {
    ...
    R = (I, X) => {
      const B = X[1];
      J(I, X),
        O(I) ? I.every((oe) => oe.length <= 1) && B() : I.length <= 1 && B();
    },
    le = {
      mode: o,
      persisted: i,
...
function Pr(e, t = !1, n) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    i.type === fe
      ? (i.patchFlag & 128 && r++, (s = s.concat(Pr(i.children, t, l))))
      : (t || i.type !== Ke) && s.push(l != null ? nt(i, { key: l }) : i);
  }
...
function Lr(e, t, n = re) {
  ...
  if ((rn(t, s, n), n)) {
    let r = n.parent;
    for (; r && r.parent; )
      Ir(r.parent.vnode) && vi(s, t, n, r), (r = r.parent);
  }
}
function vi(e, t, n, s) {
  const r = rn(t, e, s, !0);
...
function Oi(e) {
  ...
  if (l) for (const q in l) $r(l[q], s, n, q);
  if (f) {
...
function Zn(e) {
  ...
  return (
    l
      ...
      : !r.length && !n && !s
      ? (f = t)
      : ((f = {}), r.length && r.forEach((a) => zt(f, a, i, !0)), zt(f, t, i)),
    k(t) && o.set(t, f),
    f
  );
}
      ...
      mount(a, d, _) {
        if (!l) {
          ...
          return (
            ...
            (f._container = a),
            (a.__vue_app__ = f),
            cn(C.component) || C.component.proxy
          );
        }
      },
      unmount() {
...
function Di(e, t, n, s) {
  ...
  if ((s || i > 0) && !(i & 16)) {
    ...
    let d;
    for (const _ in l)
      (!t || (!N(t, _) && ((d = dt(_)) === _ || !N(t, d)))) &&
        (f
          ? n &&
            (n[_] !== void 0 || n[d] !== void 0) &&
            (r[_] = Nn(f, l, _, void 0, e, !0))
          : delete r[_]);
    if (o !== l) for (const _ in o) (!t || !N(t, _)) && (delete o[_], (a = !0));
  }
  a && Me(e.attrs, "set", "");
}
function Ur(e, t, n, s) {
...
function Br(e, t, n = !1) {
  ...
  if (O(o))
    ...
    for (const d in o) {
      ...
      if (Ss(_)) {
        const C = o[d],
          T = (i[_] = O(C) || L(C) ? { type: C } : Z({}, C));
        if (T) {
          const D = Ps(Boolean, T.type),
            F = Ps(String, T.type);
          (T[0] = D > -1),
            (T[1] = F < 0 || D < F),
            (D > -1 || N(T, "default")) && l.push(_);
        }
      }
    }
  const a = [i, l];
...
function Bi(e, t) {
  ...
  const {
    ...
    F = (
      ...
      if (c === u) return;
      c && !it(c, u) && ((p = It(c)), Ae(c, g, b, !0), (c = null)),
        u.patchFlag === -2 && ((v = !1), (u.dynamicChildren = null));
      const { type: m, ref: w, shapeFlag: S } = u;
      switch (m) {
        case on:
          se(c, u, h, p);
          break;
        ...
        default:
          S & 1
            ...
            : S & 6
            ? G(c, u, h, p, g, b, x, y, v)
            : (S & 64 || S & 128) && m.process(c, u, h, p, g, b, x, y, v, pt);
      }
    ...
    J = (c, u, h, p, g, b, x, y, v) => {
      u.type === "svg" ? (x = "svg") : u.type === "math" && (x = "mathml"),
        c == null ? R(u, h, p, g, b, x, y, v) : X(c, u, g, b, x, y, v);
    },
    R = (c, u, h, p, g, b, x, y) => {
      let v, m;
      const { props: w, shapeFlag: S, transition: A, dirs: P } = c;
      if (
        ((v = c.el = i(c.type, b, w && w.is, w)),
        S & 8
          ? d(v, c.children)
          : S & 16 && I(c.children, v, null, p, g, mn(c, b), x, y),
        P && qe(c, null, p, "created"),
        le(v, c, c.scopeId, x, p),
        w)
      ) {
        for (const j in w)
          j !== "value" &&
            !yt(j) &&
            o(v, j, null, w[j], b, c.children, p, g, Le);
        "value" in w && o(v, "value", null, w.value, b),
          (m = w.onVnodeBeforeMount) && Te(m, p, c);
      }
      P && qe(c, null, p, "beforeMount");
      const M = Ki(g, A);
      M && A.beforeEnter(v),
        s(v, u, h),
        ((m = w && w.onVnodeMounted) || M || P) &&
          ae(() => {
            m && Te(m, p, c), M && A.enter(v), P && qe(c, null, p, "mounted");
          }, g);
    },
    le = (c, u, h, p, g) => {
      if ((h && T(c, h), p)) for (let b = 0; b < p.length; b++) T(c, p[b]);
      if (g) {
        let b = g.subTree;
        if (u === b) {
          const x = g.vnode;
    ...
    X = (c, u, h, p, g, b, x) => {
      const y = (u.el = c.el);
      let { patchFlag: v, dynamicChildren: m, dirs: w } = u;
      v |= c.patchFlag & 16;
      const S = c.props || K,
        A = u.props || K;
      let P;
      if (
        (h && Je(h, !1),
        (P = A.onVnodeBeforeUpdate) && Te(P, h, u, c),
        w && qe(u, c, h, "beforeUpdate"),
        h && Je(h, !0),
        m
          ? B(c.dynamicChildren, m, y, h, p, mn(u, g), b)
          : x || U(c, u, y, null, h, p, mn(u, g), b, !1),
        v > 0)
      ) {
        if (v & 16) oe(y, u, S, A, h, p, g);
        else if (
          (v & 2 && S.class !== A.class && o(y, "class", null, A.class, g),
          v & 4 && o(y, "style", S.style, A.style, g),
          v & 8)
        ) {
    ...
    B = (c, u, h, p, g, b, x) => {
      for (let y = 0; y < u.length; y++) {
        const v = c[y],
          m = u[y],
          w =
            v.el && (v.type === fe || !it(v, m) || v.shapeFlag & 70)
              ? _(v.el)
              : h;
    ...
    oe = (c, u, h, p, g, b, x) => {
      if (h !== p) {
        if (h !== K)
          for (const y in h)
            !yt(y) && !(y in p) && o(c, y, h[y], null, x, u.children, g, b, Le);
        for (const y in p) {
          if (yt(y)) continue;
          const v = p[y],
            m = h[y];
    ...
    E = (c, u, h, p, g, b, x, y, v) => {
      ...
      let { patchFlag: S, dynamicChildren: A, slotScopeIds: P } = u;
      P && (y = y ? y.concat(P) : P),
        c == null
          ? (s(m, h, p), s(w, h, p), I(u.children || [], h, w, g, b, x, y, v))
          : S > 0 && S & 64 && A && c.dynamicChildren
          ? (B(c.dynamicChildren, A, h, g, b, x, y),
    ...
    te = (c, u, h, p, g, b, x) => {
      const y = () => {
          if (c.isMounted) {
            let { next: w, bu: S, u: A, parent: P, vnode: M } = c;
            {
              const rt = Gr(c);
              if (rt) {
                w && ((w.el = M.el), q(c, w, x)),
            ...
            let j = w,
              W;
            Je(c, !1),
              w ? ((w.el = M.el), q(c, w, x)) : (w = M),
              S && jt(S),
              (W = w.props && w.props.onVnodeBeforeUpdate) && Te(W, P, w, M),
              Je(c, !0);
            const ne = hn(c),
              Ce = c.subTree;
            (c.subTree = ne),
              F(Ce, ne, _(Ce.el), It(Ce), c, g, b),
              (w.el = ne.el),
              j === null && ii(c, ne.el),
              A && ae(A, g),
              (W = w.props && w.props.onVnodeUpdated) &&
                ae(() => Te(W, P, w, M), g);
          } else {
            let w;
            const { el: S, props: A } = u,
              { bm: P, m: M, parent: j } = c,
              W = Vt(u);
            if (
              (Je(c, !1),
              P && jt(P),
              !W && (w = A && A.onVnodeBeforeMount) && Te(w, j, u),
              Je(c, !0),
              S && is)
            ) {
              const ne = () => {
              ...
              W
                ? u.type.__asyncLoader().then(() => !c.isUnmounted && ne())
                : ne();
            } else {
            ...
            (u.shapeFlag & 256 ||
              (j && Vt(j.vnode) && j.vnode.shapeFlag & 256)) &&
              c.a &&
              ae(c.a, g),
              (c.isMounted = !0),
              (u = h = p = null);
    ...
    U = (c, u, h, p, g, b, x, y, v = !1) => {
      ...
      P & 8
        ? (w & 16 && Le(m, g, b), S !== m && d(h, S))
        : w & 16
        ? P & 16
          ? Pt(m, S, h, p, g, b, x, y, v)
          : Le(m, g, b, !0)
        : (w & 8 && d(h, ""), P & 16 && I(S, h, p, g, b, x, y, v));
    },
      ...
      if (m > S) {
        if (m <= A) {
          const P = A + 1,
            M = P < w ? u[P].el : p;
          for (; m <= A; )
            F(null, (u[m] = v ? je(u[m]) : Oe(u[m])), h, M, g, b, x, y, v), m++;
        }
      } else if (m > A) for (; m <= S; ) Ae(c[m], g, b, !0), m++;
      else {
        const P = m,
          M = m,
          j = new Map();
        ...
        for (W = cs.length - 1, m = Ce - 1; m >= 0; m--) {
          ...
          gt[m] === 0
            ? F(null, Se, h, fs, g, b, x, y, v)
            : rt && (W < 0 || m !== cs[W] ? Ge(Se, h, fs, 2) : W--);
        }
      }
    },
    Ge = (c, u, h, p, g = null) => {
      const { el: b, type: x, transition: y, children: v, shapeFlag: m } = c;
      if (m & 6) {
      ...
      if (p !== 2 && m & 1 && y)
        if (p === 0) y.beforeEnter(b), s(b, u, h), ae(() => y.enter(b), g);
          ...
          const { leave: S, delayLeave: A, afterLeave: P } = y,
            M = () => s(b, u, h),
            j = () => {
              S(b, () => {
                M(), P && P();
    ...
    Ae = (c, u, h, p = !1, g = !1) => {
      ...
      const P = w & 1 && A,
        M = !Vt(c);
      let j;
      if ((M && (j = x && x.onVnodeBeforeUnmount) && Te(j, u, c), w & 6))
        io(c.component, h, p);
      else {
        if (w & 128) {
        ...
        P && qe(c, null, u, "beforeUnmount"),
          w & 64
            ? c.type.remove(c, u, h, g, pt, p)
            : m && (b !== fe || (S > 0 && S & 64))
            ? Le(m, u, h, !1, !0)
            : ((b === fe && S & 384) || (!g && w & 16)) && Le(v, u, h),
          p && ss(c);
      }
      ((M && (j = x && x.onVnodeUnmounted)) || P) &&
        ae(() => {
    ...
    io = (c, u, h) => {
      const { bum: p, scope: g, update: b, subTree: x, um: y } = c;
      p && jt(p),
        g.stop(),
        b && ((b.active = !1), Ae(x, c, u, h)),
        y && ae(y, u),
        ae(() => {
          c.isUnmounted = !0;
        }, u),
  ...
  const rs = (c, u, h) => {
      c == null
        ...
        : F(u._vnode || null, c, u, null, null, null, h),
        fn || ((fn = !0), ys(), xr(), (fn = !1)),
        (u._vnode = c);
    },
    pt = {
  ...
  let os, is;
  return { render: rs, hydrate: os, createApp: Fi(rs, os) };
}
...
function qr(e) {
  return (
    (e.dynamicChildren = Tt > 0 ? Ee || ct : null),
    zi(),
    Tt > 0 && Ee && Ee.push(e),
    e
  );
...
function qi(e, t = null, n = null, s = 0, r = null, o = !1) {
  ...
  if ((ll(e) && (e = e.__vccOpts), t)) {
    ...
    l && !ee(l) && (t.class = Et(l)),
      k(f) && (_r(f) && !O(f) && (f = Z({}, f)), (t.style = Zt(f)));
  }
...
function ts(e, t) {
  ...
  if (t == null) t = null;
    ...
    L(t)
      ...
      : ((t = String(t)), s & 64 ? ((n = 16), (t = [Xi(t)])) : (n = 8));
...
let Gt, Dn;
{
  ...
  (Gt = t("__VUE_INSTANCE_SETTERS__", (n) => (re = n))),
    (Dn = t("__VUE_SSR_SETTERS__", (n) => (ln = n)));
}
const Ot = (e) => {
    const t = re;
    return (
    ...
    if (!t && Ms && !s.render) {
      ...
      if (r) {
        const { isCustomElement: o, compilerOptions: i } = e.appContext.config,
          ...
          a = Z(Z({ isCustomElement: o, delimiters: l }, i), f);
        s.render = Ms(r, a);
      }
    }
...
function cn(e) {
  if (e.exposed)
    return (
      e.exposeProxy ||
      (e.exposeProxy = new Proxy(br(Ko(e.exposed)), {
        get(t, n) {
...
function Ds(e, t, n, s) {
  ...
  const { type: i, timeout: l, propCount: f } = eo(e, t);
  if (!i) return s();
  const a = i + "end";
  let d = 0;
  const _ = () => {
...
function eo(e, t) {
  ...
  let d = null,
    ...
    C = 0;
  t === $e
    ? i > 0 && ((d = $e), (_ = i), (C = o.length))
    : t === mt
    ? a > 0 && ((d = mt), (_ = a), (C = f.length))
    : ((_ = Math.max(i, a)),
      (d = _ > 0 ? (i > a ? $e : mt) : null),
      (C = d ? (d === $e ? o.length : f.length) : 0));
  const T =
    d === $e && /\b(transform|all)(,|$)/.test(s(`${$e}Property`).toString());
  return { type: d, timeout: _, propCount: C, hasTransform: T };
}
function Hs(e, t) {
...
function Cl(e, t, n) {
  ...
  if (n && !r) {
    if (t)
      ...
      else for (const i in t) n[i] == null && Kt(s, i, "");
...
function Kt(e, t, n) {
  if (O(n)) n.forEach((s) => Kt(e, t, s));
    ...
    const s = xl(e, t);
    Us.test(n)
      ? e.setProperty(dt(s), n.replace(Us, ""), "important")
      : (e[s] = n);
  }
}
...
const no = new WeakMap(),
  ...
  ro = {
    ...
    props: Z({}, hl, { tag: String, moveClass: String }),
    setup(e, { slots: t }) {
      const n = tl(),
        s = gi();
      let r, o;
              ...
              const _ = (a[qt] = (C) => {
                (C && C.target !== a) ||
                  ((!C || /transform$/.test(C.propertyName)) &&
                    (a.removeEventListener("transitionend", _),
                    (a[qt] = null),
                    De(a, i)));
              });
          ...
          if (((r = []), o))
            for (let a = 0; a < o.length; a++) {
              ...
              d.el &&
                ...
                (r.push(d),
                In(d, Pn(d, l, s, n)),
                no.set(d, d.el.getBoundingClientRect()));
            }
  ...
  Ul = {
    created(e, { modifiers: { lazy: t, trim: n, number: s } }, r) {
      ...
      lt(e, t ? "change" : "input", (i) => {
        ...
        t ||
          (lt(e, "compositionstart", Vl),
          lt(e, "compositionend", Js),
          lt(e, "change", Js));
    },
    mounted(e, { value: t }) {
      e.value = t ?? "";
...
const Gl =
    ...
    methods: {
      ...
      LoadCategories() {
        this.AchievementsCategories = [
          { name: "all", label: "Wszystkie osiągnięcia" },
        ];
        for (let e of this.Achievements)
          this.AchievementsCategories.find((t) => t.name == e.category) ||
            this.AchievementsCategories.push({
              name: e.category,
      ...
      GetProgress(e) {
        ...
        return t
          ? (t == null ? void 0 : t.progress) >=
            (n == null ? void 0 : n.maxProgress)
            ? `Data odblokowania <span style='color: rgba(255, 220, 23, 0.78);'>${t.dateUnlocked}</span>`
            : `Wykonano <span style='color: rgba(255, 154, 38, 0.78);'>${
                t == null ? void 0 : t.progress
              }/${n == null ? void 0 : n.maxProgress} (${Math.floor(
                ((t == null ? void 0 : t.progress) /
                  (n == null ? void 0 : n.maxProgress)) *
                  100
              )}%)</span>`
          : `Wykonano <span style='color: rgba(255, 154, 38, 0.78);'>0/${n.maxProgress} (0%)</span>`;
      },
      SelectCategory(e) {
      ...
      ClaimReward(e) {
        ...
        t.collected = !0;
        try {
          fetch("https://mrg_achivements/ClaimReward", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ AchivementID: e }),
          })
            .then((n) => n.json())
            .then((n) => {})
            .catch((n) => {});
        ...
        const t = setInterval(() => {
          ...
          if (e < this.PlayerAchievements.length) {
            const s = this.PlayerAchievements[e],
              r =
                (n = this.Achievements.find((o) => o.id == s.id)) == null
                  ? void 0
                  : n.maxProgress;
    ...
    watch: {
      Achievements() {
        this.Achievements &&
          ...
          !this.LoadedConfig &&
          ((this.LoadedConfig = !0), this.LoadCategories());
      },
      Visible() {
        if (!this.Visible)
          try {
            fetch("https://mrg_achivements/Close", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({}),
            })
  ...
  Ql = { class: "input" },
  Zl = Jl(() =>
    Q("div", { class: "icon" }, [Q("img", { src: Gl, alt: "" })], -1)
  ),
  ec = { class: "content" },
  tc = { class: "categories" },
  nc = ["onClick"],
  sc = { class: "achivements" },
  rc = { class: "header" },
  oc = ["innerHTML"],
  ic = { class: "title" },
  lc = { class: "desc" },
                ...
                return (
                  ...
                  we("div", null, [
                    ...
                    (r.SelectedCategory == "all" ||
                      i.category.toLowerCase() == r.SelectedCategory)
                      ? (ge(),
                        we(
                          "div",
                          {
                          ...
                          [
                            Q("div", rc, [
                              o.GetProgress(i.id)
                                ...
                                : Ht("", !0),
                              Q("div", ic, bt(i.achievementLabel), 1),
                            ]),
                            Q("div", lc, bt(i.achievementDesc), 1),
                            !(
                              (f = r.PlayerAchievements.find(
                                (d) => d.id == i.id
                              )) != null && f.collected
                            ) &&
                            ((a = r.PlayerAchievements.find(
                              (d) => d.id == i.id
                            )) == null
                              ? void 0
                              : a.progress) >= i.maxProgress
                              ? (ge(),
                                we(
                                  "div",
                                  {
...
const uc = ns(ql, [
  ...
  ac = "" + new URL("epic-DVpjeEXl.png", import.meta.url).href,
  dc = "" + new URL("epic-DVpjeEXl.png", import.meta.url).href,
  hc = "" + new URL("epic-DVpjeEXl.png", import.meta.url).href,
  pc = "" + new URL("epic-DVpjeEXl.png", import.meta.url).href,
  gc = "" + new URL("archi1-DMc5uuho.wav", import.meta.url).href,
  mc = "" + new URL("archi2-CQp4pVEu.wav", import.meta.url).href,
  _c = {
    props: ["Achievements"],
    data() {
      return {
        CanPlaySound: !0,
        AchivementsSounds: { archi1: gc, archi2: mc },
        AchivementsIcons: { basic: ac, common: dc, rare: hc, epic: pc },
        Visible: !0,
        AchivementID: 0,
        AchivementsNotifys: [],
      };
      ...
      AddNotify(e) {
        ...
        if (t) {
          ...
          if (
            ...
            this.CanPlaySound = !1;
            const s = new Audio(
              this.AchivementsSounds[t.type == "epic" ? "archi2" : "archi1"]
            );
            s.play(),
          ...
          setTimeout(() => {
            this.AchivementsNotifys = this.AchivementsNotifys.filter(
              (s) => s.id !== n
            );
          }, 1e4);
        }
  ...
  bc = ["src"],
  vc = { class: "header" },
  Cc = Q("div", { class: "info" }, "ODBLOKOWANO OSIĄGNIĘCIE", -1),
  xc = { class: "title" },
  wc = { class: "desc" };
      ...
      { name: "notify", tag: "main" },
      {
        default: Ar(() => [
          ...
          we(
            ...
            null,
            Ln(
              r.AchivementsNotifys,
              (i, l) => (
                ge(),
                we("div", { class: "notify", key: l }, [
                  Q("div", yc, [
                    Q("img", { src: i.icon, alt: "" }, null, 8, bc),
                  ]),
                  Q("div", vc, [Cc, Q("div", xc, bt(i.title), 1)]),
                  Q("div", wc, bt(i.desc), 1),
                  Q("div", { class: "image-right" }, [
                    Q("img", { src: i.icon, alt: "" }, null, 8, bc),
                  ]),
                ])
              )
...
const Ac = ns(_c, [["render", Ec]]),
  Sc = {
    components: { Unlock: Ac, Container: uc },
    data() {
      return { Dead: !1, Achievements: [] };
    },
    methods: {
      Event(e) {
        e.data.action == "Open"
          ? this.$refs.Container.OpenNUI(e.data.playerAchivments)
          : e.data.action == "LoadConfig"
          ? (this.Achievements = e.data.config)
          : e.data.action == "achivmentUnlocked"
          ? this.$refs.Unlock.AddNotify(e.data.id)
          : e.data.action == "updatePosition" && (this.Dead = e.data.death);
      },
    },
    mounted() {
      ...
      [
        ve(
          i,
          {
            ...
            style: r.Dead ? Zt({ top: "9vh" }) : Zt({ bottom: "9vh" }),
          },
          null,
          8,
          ["Achievements", "style"]
        ),
        ve(l, { ref: "Container", Achievements: r.Achievements }, null, 8, [
          "Achievements",
        ]),
      ],
      64
