Config = {
    ...
    Text = {
        BACK = "Wyjdź",
        HIT = "Strzel",
        BALL_IN_HAND = "Weź bilę",
        BALL_IN_HAND_BACK = "Wyjdź",
        AIM_LEFT = "Skręć w lewo",
        AIM_RIGHT = "Skręć w prawo",
        AIM_SLOWER = "Powolne celowanie",

        POOL = 'Bilard',
        POOL_GAME = 'Gra w bilarda',
        POOL_SUBMENU = 'Tryb gry',
        TYPE_8_BALL = '9 Bil',
        TYPE_STRAIGHT = '15 Bil',

        HINT_SETUP = 'Zacznij grę',
        HINT_TAKE_CUE = 'Weź kij',
        HINT_RETURN_CUE = ' Odłóż kij',
        HINT_HINT_TAKE_CUE = 'Aby grać w bilarda, musisz zdobyć kij',
        HINT_PLAY = 'Graj',

        BALL_IN_HAND_LEFT = 'Lewo',
        BALL_IN_HAND_RIGHT = 'Prawo',
        BALL_IN_HAND_UP = 'Góra',
        BALL_IN_HAND_DOWN = 'Dół',
        BALL_POCKETED = '%s trafiła do dziury',
