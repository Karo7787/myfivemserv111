...
Config.RefreshRate = 100 -- if default dist is 25.0 leave it on 250, if you increase refresh rate, you need to increase default dist
...
Config.Notification = function(xPlayer, text) -- server side
    TriggerClientEvent('esx:showNotification', xPlayer, text)
end
