...
function ESX.ShowAdvancedNotification(message, type, time, title)
    if GetResourceState("nrp_notify") ~= "missing" then

        exports["nrp_notify"]:Notify('information', 'Powiadomienie', message)
    end
end
...
AddEventHandler('esx:showNotification', function(message, type, time, title)
    ESX.ShowNotification(message, type, time, title)
end)
