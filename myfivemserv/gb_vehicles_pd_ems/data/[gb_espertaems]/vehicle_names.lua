Citizen.CreateThread(function()
	AddTextEntry("GBEMSESPERTA", "Rumpo Esperta EMS")
	...
	AddTextEntry("ESPERTAEMS_LIV1", "Los Santos Fire Department")
	AddTextEntry("ESPERTAEMS_LIV2", "Los Santos County Fire Department")
	AddTextEntry("ESPERTAEMS_LIV3", "Blaine County Fire Department")
	AddTextEntry("ESPERTAEMS_LIV4", "Misson Row San Andreas")
	AddTextEntry("ESPERTAEMS_LIV5", "The Bay Care Center")
	AddTextEntry("ESPERTAEMS_LIV6", "Central Los Santos Medical Center")
	AddTextEntry("ESPERTAEMS_LIV7", "Mount Zonah Medical Center")
	AddTextEntry("ESPERTAEMS_LIV8", "Pillbox Hill Medical Center")
	AddTextEntry("ESPERTAEMS_LIV9", "St. Fiacre Hospital for East Los Santos")
	AddTextEntry("ESPERTAEMS_LIV10", "Sandy Shores Medical Center")
	AddTextEntry("ESPERTAEMS_LIV11", "NOOSE Tactical EMS")
end)
