...
Config.Companies.Services = {
    ...
    },
    {
        ...
        icon = "https://waters20.github.io/centralcity.github.io/Logo_LSFD.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        ...
        icon = "https://waters20.github.io/centralcity.github.io/doj.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "bean",
        name = "Bean Machine",
        icon = "https://waters20.github.io/centralcity.github.io/bean.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "uwucafe",
        name = "UwU Cafe",
        icon = "https://waters20.github.io/centralcity.github.io/uwucafe.jpg",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        job = "papa",
        name = "Papa Gustavo",
        icon = "https://waters20.github.io/centralcity.github.io/papa.png",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss"}, -- ranks that can manage the company
        location = {
...
Config.Locations = { -- Locations that'll appear in the maps app.
    {
        position = vector2(-1103.08, -836.46),
        name = "LSPD",
        description = "Los Santos Police Department",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
    },
    {
        position = vector2(81.11, -412.68),
        name = "Rockford Hospital",
        description = "Rockford Medical Hospital",
        icon = "https://cdn-icons-png.flaticon.com/128/1032/1032989.png",
    },
    { 
        position = vector2(-343.16, -129.74),
        name = "Mechanic",
        description = "Los Santos Customs",
        icon = "https://cdn-icons-png.flaticon.com/128/10281/10281554.png",
    },
    { 
        position = vector2(891.85, -158.03),
        name = "Taxi",
        description = "Taxi",
        icon = "https://cdn-icons-png.flaticon.com/128/433/433449.png",
    },
    { 
        position = vector2(-550.1, -195.02),
        name = "Department of Justice",
        description = "Department of Justice",
        icon = "https://waters20.github.io/centralcity.github.io/doj.png",
    },
    { 
        position = vector2(-581.76, -1061.73),
        name = "UwU Cafe",
        description = "UwU Cafe",
        icon = "https://waters20.github.io/centralcity.github.io/uwucafe.jpg",
    },
    { 
        position = vector2(120.83, -1033.97),
        name = "Bean Machine",
        description = "Bean Machine",
        icon = "https://waters20.github.io/centralcity.github.io/bean.png",
    },
    { 
        position = vector2(93.95, 8.21),
        name = "Papa Gustavo",
        description = "Papa Gustavo",
        icon = "https://waters20.github.io/centralcity.github.io/papa.png",
    },
    { 
        position = vector2(-1047.14, -1398.54),
        name = "Los Stantos Fire Department",
        description = "Los Stantos Fire Department",
        icon = "https://waters20.github.io/centralcity.github.io/Logo_LSFD.png",
    },
}
...
Config.EmailDomain = "miragerp.pl"
