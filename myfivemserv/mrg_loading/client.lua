...
--     Wait(15000)
--     NewLoadSceneStartSphere(-1597.96, -2791.44, 13.96, 1000, 0)
--     Wait(17520) --- custscene time
-- 	for v_3=0, 6, 1 do
...
--     DoScreenFadeOut(0)
--     PrepareMusicEvent("AC_STOP")
--     exports["mrg_ui"]:Cinematic(false)
--     Wait(500)
--     DoScreenFadeIn(500)
--     SetEntityCoords(PlayerPedId(),-1033.82, -2737.79, 20.17)
-- end) 
