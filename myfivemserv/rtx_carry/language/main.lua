Language = {
    ["English"] = {
		...
		["carrytarget1"] = "Podnies na bark",
		["carrytarget2"] = "Podnies na rece",
		["carrytarget3"] = "Na barana",
    ...
    ["Polski"] = {
        ["noplayernearby"] = "Brak gracza w pobliżu.",
        ["invehicle"] = "Jesteś w pojeździe.",
        ["youcarrysomeone"] = "Już kogoś nosisz.",
        ["someonecarryou"] = "Ktoś cię nosi.",
        ["requestalready"] = "Już wysłałeś prośbę do kogoś.",
        ["targetcarrysomeone"] = "Cel niesie kogoś.",
        ["targetcarryed"] = "Cel jest już niesiony.",
        ["targethaverequest"] = "Cel ma już prośbę o przeniesienie od kogoś.",
        ["targetmenu"] = "Cel ma otwarte menu przenoszenia.",
        ["norequestdistance"] = "Nie jesteś w pobliżu gracza, od którego chcesz prosić.",
        ["requestdenied"] = "Prośba o przeniesienie została odrzucona.",
        ["agreecarry"] = "Zaakceptuj przenoszenie",
        ["declinecarry"] = "Odrzuć przenoszenie",
        ["carrytarget1"] = "Podnieś na bark",
        ["carrytarget2"] = "Podnieś na ręce",
        ["carrytarget3"] = "Na barana",
        ["releaseplayer"] = "Pość Gracza",
        },
}