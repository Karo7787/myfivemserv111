...
// 		clearInterval(this.focusTimer);
// 		window.removeEventListener('message', this.listener);
// 		document.body.removeEventListener('load', this.loadListener);
// 	},
// 	mounted() {
// 		post('https://chat/loaded', JSON.stringify({}));
// 		this.listener = window.addEventListener('message', event => {
...
// 		this.loadListener = document.body.addEventListener(
// 			'load',
// 			event => {
...
// 	computed: {
// 		suggestions() {
// 			return this.backingSuggestions
// 		}
// 	},
// 	methods: {
// 		ON_SCREEN_STATE_CHANGE({ shouldHide }) {
...
// 			// this.messages.push({
// 			// 	args: [message],
// 			// 	template: `<div class="flex" style="background-image: linear-gradient(90deg, rgba(100, 0, 0, 0.8) 0%, rgba(100, 0, 0, 0.2) 100%);">
// 			// 					<p>{0}</p>
// 			// 				</div>`
// 			// })
// 			// ;
...
// 				suggestion.params = []; //TODO Move somewhere else
// 			}
// 			if (this.backingSuggestions.find(a => a.name == suggestion.name && a.params.length > 0)) {
// 				return;
// 			}else if(this.backingSuggestions.find(a => a.name == suggestion.name)){
// 				this.backingSuggestions[this.backingSuggestions.findIndex(a => a.name == suggestion.name)] = suggestion
// 			}else{
// 				this.backingSuggestions.push(suggestion)
// 			}
// 		},
// 		ON_SUGGESTION_REMOVE({ name }) {
// 			if (this.backingSuggestions.find(a => a.name = name)) {
// 				this.backingSuggestions.splice(this.backingSuggestions.findIndex(a => a.name == name), 1)
// 			}
// 		},
// 		ON_TEMPLATE_ADD({ template }) {
// 			this.templates[template.id] = template.html;
...
// 		},
// 		autocomplete() {
// 			let firstSuggestion = this.backingSuggestions.filter(el =>
// 				el.name.toLowerCase().match(this.message.toLowerCase())
// 			)[0];
