...
window.addEventListener('message', function (event) {
	...
	if (item.message == "tvshow") {
		...
		if (item.tvurldata == "") {	
			...
			document.getElementById("currently-playing").innerHTML = "<i class='fas fa-play-circle'></i> &ensp;Obecnie nie jest odtwarzane żadne wideo";
		} else {
			document.getElementById("currently-playing").innerHTML = "<i class='fas fa-play-circle'></i> &ensp;Odtwarzanie";
