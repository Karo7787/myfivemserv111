...
RegisterNUICallback('SavePicture', function(data)
	...
	exports["lb-phone"]:SaveToGallery(data.Saving.image)
end)
...
RegisterNUICallback('TakeScreenShot', function()
	...
	local data2 = 'data'
	ESX.TriggerServerCallback('mrg_cameramode:generate:url', function(data)
		exports['screenshot-basic']:requestScreenshotUpload(tostring(data.url), "file", {
			headers = {},
			encoding = 'jpg',
			metadata = {
