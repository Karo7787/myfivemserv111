...
local txd = CreateRuntimeTxd('mirage_sprites')
CreateRuntimeTextureFromImage(txd, "closed", 'icons/closed.png')
CreateRuntimeTextureFromImage(txd, "opened", 'icons/opened.png')
